    ...
    return GetBuilder<OrderController>(builder: (orderController) {
        ...
        return Scaffold(
          ...
          appBar: CustomAppBarWidget(
            ...
            subTitle: order != null && widget.orderModel.orderStatus != null ? '${'order_is'.tr} ${widget.orderModel.orderStatus!.tr}' : null,
            menuWidget: InkWell(
              onTap: (){
                Get.dialog(Dialog(
          ...
          body: (orderController.orderDetailsModel != null && controllerOrderModel != null && restaurant != null) ? Column(children: [
            ...
            Expanded(child: SingleChildScrollView(
              child: Center(child: SizedBox(width: 1170, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                order.deliveryMan != null ? SectionWidget(
                ...
                ) : Get.find<ProfileController>().profileModel!.restaurants![0].selfDeliverySystem == 1 && canShowDeliveryMan
                ? SectionWidget(
                  title: 'delivery_man_info'.tr,
                  child: InkWell(
                    onTap: () {
